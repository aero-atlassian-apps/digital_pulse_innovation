export const resources = {
  en: {
    translation: {
      ...
      clients: {
        ...
        track_record: "Our Proven Track Record",
        track_desc: "We partner with industry leaders to achieve measurable results.",
        case_studies: "In-Depth Case Studies",
        metrics: {
          market: "Faster Time-to-Market",
          bugs: "Reduction in Bugs",
          adoption: "User Adoption Rate"
        }
      },
      propositions: {
        title: "Solutions that Drive Outcomes",
        subtitle: "We focus on value creation, performance and client experience.",
        results: {
          title: "Results-Oriented",
          desc: "Create value by aligning strategy and execution to your goals."
        },
        performance: {
          title: "Performance-Oriented",
          desc: "Install continuous improvement across processes to remove waste and amplify strengths."
        },
        client: {
          title: "Client-Oriented",
          desc: "Optimize customer experience to boost loyalty and revenue across the journey."
        }
      },
      metrics: {
        values: {
      ...
      about: {
        ...
        mission_desc: "Empowering organizations through transformative digital solutions.",
        values_title: "Our Core Values",
        values: {
          innovation: "Driven by Innovation",
          craft: "Commitment to Craftsmanship",
          collab: "Partnership & Collaboration"
        }
      },
      contact: {
        title: "Get in Touch",
        subtitle: "We'd love to hear from you. Reach out for inquiries.",
        form: {
          name: "Name",
          email: "Email",
          company: "Company",
  ...
  fr: {
    translation: {
      ...
      clients: {
        ...
        track_record: "Notre Palmarès Éprouvé",
        track_desc: "Nous travaillons avec des leaders de l'industrie pour obtenir des résultats mesurables.",
        case_studies: "Études de Cas Détaillées",
        metrics: {
          market: "Délai de mise sur le marché",
          bugs: "Réduction des bugs",
          adoption: "Taux d'adoption utilisateur"
        }
      },
      propositions: {
        title: "Des solutions orientées résultats",
        subtitle: "Nous créons de la valeur, améliorons la performance et optimisons l’expérience client.",
        results: {
          title: "Orientées Résultats",
          desc: "Création de valeur en alignant la stratégie et l’opérationnel sur vos objectifs."
        },
        performance: {
          title: "Orientées Performance",
          desc: "Démarche d’amélioration continue pour éliminer les dysfonctionnements et renforcer les atouts générateurs de valeur."
        },
        client: {
          title: "Orientées Client",
          desc: "Optimisation de l’expérience client pour fidéliser et augmenter les revenus sur l’ensemble du parcours."
        }
      },
      metrics: {
        values: {
      ...
      about: {
        ...
        mission_desc: "Autonomiser les organisations grâce à des solutions numériques transformatrices.",
        values_title: "Nos Valeurs Fondamentales",
        values: {
          innovation: "Guidés par l'Innovation",
          craft: "Engagement envers l'Excellence",
          collab: "Partenariat & Collaboration"
        }
      },
      contact: {
        title: "Contactez-nous",
        subtitle: "Nous aimerions avoir de vos nouvelles. Contactez-nous pour toute demande.",
        form: {
          name: "Nom",
          email: "Email",
          company: "Entreprise",
  ...
  es: {
    translation: {
      ...
      clients: {
        title: "Líderes de la industria confían en nosotros",
        track_record: "Nuestro Historial Comprobado",
        track_desc: "Nos asociamos con líderes de la industria para lograr resultados medibles.",
        case_studies: "Estudios de Caso en Profundidad",
        metrics: {
          market: "Tiempo de comercialización más rápido",
          bugs: "Reducción de errores",
          adoption: "Tasa de adopción de usuarios"
        }
      },
      propositions: {
        title: "Soluciones orientadas a resultados",
        subtitle: "Creamos valor, mejoramos el rendimiento y optimizamos la experiencia del cliente.",
        results: {
          title: "Orientadas a Resultados",
          desc: "Crear valor alineando estrategia y ejecución con sus objetivos."
        },
        performance: {
          title: "Orientadas al Rendimiento",
          desc: "Mejora continua para eliminar ineficiencias y potenciar fortalezas."
        },
        client: {
          title: "Orientadas al Cliente",
          desc: "Optimizar la experiencia del cliente para fidelizar y aumentar ingresos."
        }
      },
      metrics: {
        values: {
      ...
      about: {
        ...
        mission_desc: "Empoderar a las organizaciones a través de soluciones digitales transformadoras.",
        values_title: "Nuestros Valores Fundamentales",
        values: {
          innovation: "Impulsados por la Innovación",
          craft: "Compromiso con la Artesanía",
          collab: "Asociación y Colaboración"
        }
      },
      contact: {
        title: "Ponte en Contacto",
        subtitle: "Nos encantaría saber de ti. Contáctanos para consultas.",
        form: {
          name: "Nombre",
          email: "Correo",
          company: "Empresa",
  ...
  ar: {
    translation: {
      ...
      clients: {
        title: "موثوقون من قبل قادة الصناعة",
        track_record: "سجل إنجازاتنا المثبت",
        track_desc: "نحن نتشارك مع قادة الصناعة لتحقيق نتائج قابلة للقياس.",
        case_studies: "دراسات حالة متعمقة",
        metrics: {
          market: "وقت أسرع للسوق",
          bugs: "تقليل الأخطاء",
          adoption: "معدل تبني المستخدم"
        }
      },
      propositions: {
        title: "حلول موجّهة نحو النتائج",
        subtitle: "نركز على خلق القيمة وتحسين الأداء وتجربة العميل.",
        results: {
          title: "موجهة نحو النتائج",
          desc: "خلق القيمة عبر مواءمة الاستراتيجية والتنفيذ مع أهدافكم."
        },
        performance: {
          title: "موجهة نحو الأداء",
          desc: "منهجية التحسين المستمر لإزالة الهدر وتعزيز نقاط القوة."
        },
        client: {
          title: "موجهة نحو العميل",
          desc: "تحسين تجربة العميل لزيادة الولاء والإيرادات عبر الرحلة."
        }
      },
      metrics: {
        values: {
      ...
      about: {
        ...
        mission_desc: "تمكين المنظمات من خلال حلول رقمية تحويلية.",
        values_title: "قيمنا الجوهرية",
        values: {
          innovation: "مدفوعون بالابتكار",
          craft: "الالتزام بالحرفية",
          collab: "الشراكة والتعاون"
        }
      },
      contact: {
        title: "تواصل معنا",
        subtitle: "نود أن نسمع منك. تواصل معنا للاستفسارات.",
        form: {
          name: "الاسم",
